...
![](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/01.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/02.png?raw=true)


ping的原理： 

![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/03.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/04.png?raw=true)

 
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/05.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/06.png?raw=true)

两台计算机通过TCP/IP的通信过程如下： 

![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/07.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/08.png?raw=true)

目的主机收到数据包后，经过各层协议栈最后到达应用程序。

![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/09.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/10.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/11.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/12.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/13.png?raw=true)

如上图所示，UDP请求，第一个请求的端口是33435 ， 接下来的UDP请求，端口会递增。 

当到达目的地址时，目的地址会replay类型为3的包.

![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/14.png?raw=true)
...
![image](https://github.com/mediaios/qifocus-docs/blob/main/img/ios-ping/15.png?raw=true)
